...
class DiffSLC:
    def __init__(self, coexpr_file, network_file):
        print("Reading Coexpressions From:", coexpr_file)
        ...
        print("Reading Graph/network From:", network_file)
    ...
    def _load_graph_from_file(self, network_file):
        print("Read a graph in any compatible format and store it in\
               a network graph object.")

    def _ecc(self):
        print("Calculate edge clustering coefficients for given\
               networkx graph")
    ...
    def centrality(self):
        print("Calculate the diffslc centrality and store it as node property\
               in a networkx graph object")
